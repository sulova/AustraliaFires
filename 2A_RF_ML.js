...
var classifier_Pro = ee.Classifier.smileRandomForest(10).setOutputMode('PROBABILITY').train(classifierTraining,"fire"); 
...
var classifier_REG = ee.Classifier.smileRandomForest(10).setOutputMode('REGRESSION').train(classifierTraining,"fire"); 
